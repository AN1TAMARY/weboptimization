...
var resizePizzas = function(size) {
    ...
    function changeSliderLabel(size) {
        var psInnerHTML = document.getElementById("pizzaSize");
        console.log(size);
        switch (size) {
            case "1":
                psInnerHTML.innerHTML = "Small";
                return;
            case "2":
                psInnerHTML.innerHTML = "Medium";
                return;
            case "3":
                psInnerHTML.innerHTML = "Large";
                return;
            default:
    ...
    function changePizzaSizes(size) {
        var rpContainer = document.getElementsByClassName("randomPizzaContainer");
        var length = rpContainer.length;
        var nwidth;
        switch (size) {
            case "1":
                nwidth = 25;
        ...
        for (var i = 0; i < length; i++) {
            rpContainer[i].style.width = nwidth + "%";
        }
    }
...
function updatePositions() {
    ...
    var scrollItems = document.body.scrollTop / 1250;
    var items = document.getElementsByClassName('mover');
    for (var i = 0; i < items.length; i++) {
        var phase = Math.sin(scrollItems + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var row = Math.ceil(sHeight / s);
    var nPizza = row * cols;
    var elem;

    var movPizzas = document.getElementById("movingPizzas1");
    //creates moving pizza
    for (var i = 0; i < nPizza; i++) {
